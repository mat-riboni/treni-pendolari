...
class RoutineRepositoryImpl implements RoutineRepository {
  ...
  Routine getRoutine() {
    ...
    final String departureTime = spRoutine.getDepartureTime() ?? "00:00";
    ...
    final String homecomingTime = spRoutine.getHomecomingTime() ?? "00:00";
    ...
    final RoutineTripModel departure = RoutineTripModel(
        ...
        departureTime: DateTimeFormatter.stringToTimeOfDay(departureTime));
    final RoutineTripModel homecoming = RoutineTripModel(
        ...
        departureTime: DateTimeFormatter.stringToTimeOfDay(homecomingTime));
